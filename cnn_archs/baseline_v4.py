...
def conv_net(x, weights, biases):
    ...
    # up block 1
    uconv2 = conv2d_transpose(conv9, weights['wuc2'], biases['ub2'], [tf.shape(conv3)[0], 430, 325, 128], strides=2)
    ...
    # up block 2
    uconv3 = conv2d_transpose(conv18, weights['wuc3'], biases['ub3'], [tf.shape(conv3)[0], 860, 650, 64], strides=2)
