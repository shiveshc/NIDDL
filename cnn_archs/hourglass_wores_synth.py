...
def conv_net(x):
    ...
    conv22 = conv2d_transpose(conv12, weights[new_w], biases[new_b], [tf.shape(conv12)[0], 32, 32, 256], strides=2)
    ...
    conv26 = conv2d_transpose(conv25, weights[new_w], biases[new_b], [tf.shape(conv12)[0], 64, 64, 128], strides=2)
    ...
    conv30 = conv2d_transpose(conv29, weights[new_w], biases[new_b], [tf.shape(conv12)[0], 128, 128, 64], strides=2)
