...
def conv_net(x, weights, biases):
    ...
    # up block 2
    uconv2 = conv2d_transpose(conv15, weights['wuc2'], biases['ub2'], [tf.shape(conv3)[0], 430, 325, 64], strides=2)
...
def wts_and_bias():
    weights = {'wc1': tf.get_variable('W0', shape=(3, 3, 1, 32), initializer=tf.contrib.layers.xavier_initializer()),
               ...
               'wc13': tf.get_variable('W13', shape=(3, 3, 128, 128), initializer=tf.contrib.layers.xavier_initializer()),
